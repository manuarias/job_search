...
function getDataDir() {
  ...
  if (!fs.existsSync(resolved)) {
    console.error(`JS_DATA_DIR is set to "${envDir}" but the directory does not exist: ${resolved}`);
    console.error('Check your JS_DATA_DIR environment variable or create the directory.');
    process.exit(1);
  }
