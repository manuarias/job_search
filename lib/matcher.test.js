 ...
 *  11. Integration with real CV + English JD keywords
...
function loadEnglishJD() {
  return fs.readFileSync(path.join(__dirname, '..', 'test-fixtures', 'anonymous-jd-en.md'), 'utf8');
}
...
// ── Integration: real CV + English JD ──────────────────────────────────────────

describe('matcher — integration with real CV and English JD', () => {
  let cvData;
  let jdKeywords;
  let result;
